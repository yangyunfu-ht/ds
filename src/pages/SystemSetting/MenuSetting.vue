<template>
	<div>
				...
				<el-row>
					...
					<el-col :span="4">
						<el-form-item label="菜单路径">
							<el-input v-model="formInline.user" placeholder="请输入菜单路径" clearable />
						</el-form-item></el-col>
					<el-col :span="6">
		...
		<el-card style="margin-top: 20px;">
			<el-row>
				<DsButton type="primary" icon="Plus" @click="handleClick">新增</DsButton>
				<DsButton type="warning" icon="Edit">修改</DsButton>
				<DsButton type="danger" icon="Delete">删除</DsButton>
			</el-row>

			<el-table :row-style="rowStyle" border :data="tableData" stripe style="width: 100%;margin-top: 20px;">
