<template>
  <el-card>
    <el-row align="middle">
      <el-col :span="4">
        <el-button @click="handleGetSystemPrinterCounter"
          >获取系统内打印机数量</el-button
        >
      </el-col>
      <el-col :span="20">
        <el-descriptions>
          <el-descriptions-item label="系统内打印机数量："
            >{{ systemPrinterCounters }}个</el-descriptions-item
          >
        </el-descriptions>
      </el-col>
    </el-row>
    <el-row style="margin-top: 20px" align="middle">
      <el-col :span="4">
        <el-button @click="handleGetDriverName"
          >获取系统内打印机驱动名称</el-button
        >
      </el-col>
      <el-col :span="20">
        <el-descriptions>
          <el-descriptions-item
            v-for="(driver, index) of printerDriverNames"
            :key="index"
    ...
    <el-row style="margin-top: 20px" align="middle">
      <el-col :span="8">
        <el-select
          v-model="selectOrder"
          placeholder="请选择打印设备进行打印"
          style="width: 400px"
          clearable
        >
          <el-option
            v-for="(driver, index) in printerDriverNames"
            :key="index"
            :label="driver"
            :value="index"
          />
