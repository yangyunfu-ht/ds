  ...
  >
    ...
    <el-sub-menu index="1">
      ...
      <el-sub-menu index="/1-3-1">
        <template #title><span>1-3</span></template>
        <el-menu-item index="/1-3-1">1-3-1</el-menu-item>
      </el-sub-menu>
    </el-sub-menu>
    ...
    <el-sub-menu index="3">
      ...
      <el-menu-item index="/3">3-1</el-menu-item>
    ...
    <el-sub-menu index="4">
      ...
      <el-menu-item index="/4">4-1</el-menu-item>
